...
import os
os.environ['LANGCHAIN_PROJECT']='3_RAG_v3'
...
# ----------------- one top-level (root) run ----------------- making complete pipeline under 1 single function so that it soed not gets spilted in langsmith portal
